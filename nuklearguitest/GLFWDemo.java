...
import static org.lwjgl.nuklear.Nuklear.nk_color_fv;
...
public class GLFWDemo {
	...
	public GLFWDemo() {
		try {
			this.ttf = ioResourceToByteBuffer("src/test/FiraSans.ttf", 160 * 1024);
		} catch (IOException e) {
	...
	private void run() {
		...
		while (!glfwWindowShouldClose(win)) {
			 ...
			 * defaults everything back into a default state. Make sure to
			 * either a.) save and restore or b.) reset your own state after
			 * rendering the UI.
			 */
