...
public final class TruetypeOversample {
	 ...
	 * TruetypeOversample().run("STB Truetype Oversample Demo"); }
	 */
	private void load_fonts() {
		...
		try (STBTTPackContext pc = STBTTPackContext.malloc()) {
			ByteBuffer ttf = ioResourceToByteBuffer("src/nuklearguitest/FiraSans.ttf", 160 * 1024);
	...
	private void draw_world() {
		...
		if (black_on_white) {
			glColor3f(1.0f, 1.0f, 0.0f);// font color
		} else {
