...
public class Fbo {
	...
	public void unbindFrameBuffer() {
		...
		GL11.glViewport(0, 0, WindowManager.getWindow("main").getWidth(), WindowManager.getWindow("main").getHeight());
	}
	...
	public void resolveToScreen() {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, WindowManager.getWindow("main").getWidth(),
				WindowManager.getWindow("main").getHeight(), GL11.GL_COLOR_BUFFER_BIT, GL11.GL_NEAREST);
		this.unbindFrameBuffer();
	}
